...
var DracoDecoderModule = (function () {
	...
	return function (m) {
		...
		function ba() {
			if (!ba.strings) {
				var a = {USER: 'web_user', LOGNAME: 'web_user', PATH: '/', PWD: '/', HOME: '/home/web_user', LANG: (('object' === typeof navigator && navigator.languages && navigator.languages[0]) || 'C').replace('-', '_') + '.UTF-8', _: na},
					c;
